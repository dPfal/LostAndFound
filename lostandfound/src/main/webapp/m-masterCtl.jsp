...
<body onLoad="pageInit('${param.message}')">
	<div id="wrap">
		<div id="header">
			...
			<div id="signup">	
				<input type="button" class="btn centerManagement" value="centerManagement" onClick="movePage("m-centerManagement.jsp","")"></input>
				<input type="button" class="btn centerPerformance" value="centerPerformance" onClick="movePage("m-centerPerformance.jsp","")"></input>
				<input type="button" class="btn centerCreate" value="centerCreate" onClick="movePage("m-centerCreate.jsp","")"></input>	
			</div>
