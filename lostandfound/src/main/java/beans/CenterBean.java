...
public class CenterBean {
	...
	public String getCenterMasterId() {
		return centerMasterId;
	}

	public void setCenterMasterId(String centerMasterId) {
		this.centerMasterId = centerMasterId;
	}
