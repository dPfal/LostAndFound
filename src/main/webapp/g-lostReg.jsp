...
<body class="vsc-initialized">
	...
	<form id="regform">
		...
		<fieldset id="regLost">
			...
			<div class="form-group">
				<label for="exampleSelect1" class="form-label mt-4">* 분실 지역</label> <select class="form-select" name="location">
					<option value="">선택</option>
			...
			<div class="form-group">
				<label for="exampleSelect1" class="form-label mt-4"> * 분실 장소 분류</label> <select class="form-select" name="place">
			...
			<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">분실 장소 상세</label> <input type="text" class="form-control" placeholder="" name="placeDetail">
			</div>
			<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">* 분실 날짜</label><input type="date" class="form-control" name="date"> 
			</div>
			<br>
			<hr>
			...
			<h5>분실물 정보 입력</h5>
			<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">* 글 제목</label> <input type="text" class="form-control" placeholder="" name="title"> <small>분실물 목록에 표시되는 제목입니다. ex) 휴대폰분실</small>
			...
			<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">* 물품명</label> <input type="text" class="form-control" placeholder="" name="articleName">
			</div>
