...
<body class="vsc-initialized">
		...
		<fieldset id="regFound">
			<div class="form-group">
				...
				<div style="display: flex; align-items: center;">
					<select style="width: 20%; margin-right: 10px;" class="form-select" name="center">
			...
			<div class="form-group">
				<label for="exampleSelect1" class="form-label mt-4">* 습득 지역</label> <select class="form-select" name="location">
					<option value="">선택</option>
			...
			<div class="form-group">
				<label for="exampleSelect1" class="form-label mt-4"> * 습득 장소 분류</label> <select class="form-select" name="place">
			...
			<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">습득 장소 상세</label> <input type="text" class="form-control" placeholder="" name="placeDetail">
			</div>
			<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">* 습득 날짜</label><input type="date" class="form-control" name="foundDate"> 
			</div>
			<br>
			<hr>
			...
			<h5>습득물 정보 입력</h5>
			<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">* 글 제목</label> <input type="text" class="form-control" placeholder="" name="title"> <small>습득물 목록에 표시되는 제목입니다. ex) 휴대폰습득</small>

			</div>
			<div>
				<label for="exampleSelect1" class="form-label mt-4 width50">* 대분류<select class="form-select " name="MainCategories" onchange="categoryChange(this)">
				...
				</label> <label for="exampleSelect1" class="form-label mt-4 width50" style="float: right">* 소분류<select class="form-select" name="SubCategories">
			...
			<div>
				...
				<label class="col-form-label mt-4 width50 " for="inputDefault">* 물품명<span class="form-group"> <input type="text" class="form-control " placeholder="" name="articleName">
				</span>
				</label><label class="col-form-label mt-4 width50 " for="inputDefault" style="float: right">분실자 명 <span class="form-group"> <input type="text" class="form-control " placeholder="" name="loserName">
				</span></label>
			</div>
			<div class="form-group width50">
				<label for="exampleSelect1" class="form-label mt-4"> * 물품 색상</label> <select class="form-select" name="color">
			...
			<div class="form-group">
				<label for="formFile" class="form-label mt-4">물품 사진 </label> <input class="form-control" type="file" name="img">
			</div>
	...
	function regFound(){
		...
		data.push(document.getElementsByName("foundDate")[0]);
