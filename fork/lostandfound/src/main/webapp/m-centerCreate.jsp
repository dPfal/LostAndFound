...
<body onLoad="pageInit('${param.message}')">
	<div id="wrap">
		...
		<div id="signup" name="signUp">
			<input type="text" id="txtsignlogo" value="Sign up"></input>
			<input type="text" class="gtxt id" name="CenterId"  placeHolder="Center Id" ></input>
			<input type="text" class="gtxt pw" name="CenterPw" placeHolder="Center Pw"></input>
			<input type="text" class="gtxt code" name="CenterCode" placeHolder="Center Code"></input>
			<input type="text" class="gtxt name" name="CenterName"  placeHolder="Center Name" ></input>
			<input type="text" class="gtxt phone" name="CenterPhone" placeHolder="Center Phone"></input>
			<input type="text" class="gtxt addr" name="CenterAddr" placeHolder="Center Addr"></input>
			<input type="text" class="gtxt locode" name="CenterLocode" placeHolder="Center Locode"></input>
			
			<input type="button" class="btn sign" value="Sign up" onClick="centerCreate()"></input>
